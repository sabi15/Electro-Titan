...
class DivisionParticipants(commands.Cog):
    @app_commands.command(name="division-participants", description="View all participants in a division.")
    @app_commands.describe(division="Division code")
    async def division_participants(self, interaction: discord.Interaction, division: str):
