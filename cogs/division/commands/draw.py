...
class DivisionDraw(commands.Cog):
    @app_commands.command(name="division-draw", description="Randomly assign participants into groups.")
    @app_commands.describe(
        division="Division code",
        schedule_name="Schedule/stage name to draw for",
        groups="Number of groups to create",
        by_timezone="Group teams by timezone before drawing"
    )
