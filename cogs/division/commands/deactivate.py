...
class DivisionDeactivate(commands.Cog):
    @app_commands.command(name="division-deactivate", description="Toggle a division active/inactive.")
    @app_commands.describe(code="The division code to toggle")
    async def division_deactivate(self, interaction: discord.Interaction, code: str):
