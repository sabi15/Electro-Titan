...
class DivisionDelete(commands.Cog):
    @app_commands.command(name="division-delete", description="Permanently delete a division.")
    @app_commands.describe(code="The division code to delete")
    async def division_delete(self, interaction: discord.Interaction, code: str):
